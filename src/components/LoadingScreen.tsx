          ...
          >
            <div className="relative w-full h-full flex flex-col items-center justify-center">
              ...
              <div className="relative mb-8">
                <GlobeLoadingAnimation onComplete={() => setShowLoader(false)} />
              </div>
              
              {/* Animated text that appears after globe */}
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 2, duration: 1 }}
                className="text-center space-y-4 absolute bottom-32"
              >
                <motion.h1
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
