  ...
  const animationOptions = [
    {
      id: "snowflake",
      name: "Золотой свет",
      description: "Тёплый луч проектора и мягкая плёночная атмосфера"
    },
    {
      id: "default",
      name: "Премьерный зал",
      description: "Классическая заставка в эстетике большого экрана"
    },
    {
      id: "globe",
      name: "Кадр за кадром",
      description: "Холодный свет и собранная кинохроника"
    },
    {
      id: "minimal",
      name: "Минималистичная",
      description: "Чистая заставка с лаконичным знаком фильма"
    },
    {
      id: "pulse",
      name: "Пульс истории",
      description: "Мягкая пульсация света вокруг кинозала"
    },
    {
      id: "cascade",
      name: "Сцена оживает",
      description: "Тёплый театральный свет перед началом сеанса"
    },
    {
      id: "glitch",
      name: "Лента в движении",
      description: "Деликатное движение старой киноленты без резких сбоев"
    }
  ];
